					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="p" step="1">
									<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=${p}&pageSize=${pageInfo.pageSize}">${p}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
								<li>
